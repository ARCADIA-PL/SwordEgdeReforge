package com.super_awesome_baby.legendary_ark.skill;
...
import com.super_awesome_baby.legendary_ark.capability.OriginalSkillCapability;
...
@Mod.EventBusSubscriber(modid = LegendaryArk.MOD_ID)
