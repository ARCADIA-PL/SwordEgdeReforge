package com.super_awesome_baby.legendary_ark.capability;
...
public class OriginalSkillEvents {
    ...
    private static final ResourceLocation CAPABILITY_ID = ResourceLocation.fromNamespaceAndPath(LegendaryArk.MOD_ID, "original_skill_memory");
